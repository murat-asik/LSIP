...
async function main() {
  ...
  const wanted = ['dist/main/modules/internet-intelligence/http-client.js','dist/main/modules/internet-intelligence/base-provider.js','dist/main/modules/internet-intelligence/provider-manager.js', ...['abuseipdb','virustotal','urlhaus','greynoise','hybridanalysis','ipqualityscore','otx','shodan'].map(name => 'dist/main/modules/internet-intelligence/providers/'+name+'.provider.js'), 'dist/main/core/backup-service.js','dist/main/core/restore-startup.js','dist/main/core/collector-health.js','dist/main/modules/event-explorer/event-pages.js','dist/main/modules/ioc-scanner/rule-library.js','dist/main/core/event-identity.js','dist/main/modules/base-module.js','dist/main/modules/plugin-system/plugin-worker.js','dist/main/modules/plugin-system/plugin-system.module.js','dist/main/modules/redteam/rdap-service.js','dist/main/core/security.js', 'dist/main/modules/fim/fim-scanner.js', 'dist/main/modules/dfir/forensic-service.js','dist/main/modules/dfir/evidence-vault.js','dist/main/modules/ioc-scanner/rule-worker.js','dist/main/modules/ai-analyst/ai-analyst.module.js', 'dist/preload/index.js'];
